...
class SQLiteSqlConnector(SqlConnector):
    ...
    async def query_execution(
        ...
        """
        # Use SQLite-specific environment variable, fall back to Tsql for backward compatibility
        db_file = os.environ.get("Text2Sql__Sqlite__Database") or os.environ.get("Text2Sql__Tsql__ConnectionString")

        if not db_file:
            raise ValueError("Text2Sql__Sqlite__Database environment variable is required for SQLite")
    ...
    async def get_entity_schemas(
        ...
        db_path = os.environ.get("Text2Sql__Sqlite__Database") or os.environ.get("Text2Sql__Tsql__ConnectionString")
